...
public:
     ...
     */
    void renderSilhouette(std::vector<Object3D*> models, GLenum polyonMode, bool invertDepth = false, const std::vector<cv::Point3f> &colors = std::vector<cv::Point3f>(), bool drawAll = false);
     ...
     *  @param drawAll Whether to draw the model even if it has not yet been initlaized for tracking (default = false).
     */
    void renderShaded(std::vector<Object3D*> models, GLenum polyonMode, const std::vector<cv::Point3f> &colors = std::vector<cv::Point3f>(), bool drawAll = false);
     ...
     *  @param drawAll Whether to draw the model even if it has not yet been initlaized for tracking (default = false).
     */
    void renderNormals(std::vector<Object3D*> models, GLenum polyonMode, bool drawAll = false);
