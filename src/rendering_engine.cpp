...
void RenderingEngine::renderSilhouette(Model* model, GLenum polyonMode, bool invertDepth, float r, float g, float b, bool drawAll)
{
    ...
    renderSilhouette(objects, polyonMode, invertDepth, colors, drawAll);
...
void RenderingEngine::renderShaded(Model* model, GLenum polyonMode, float r, float g, float b, bool drawAll)
{
    ...
    renderShaded(objects, polyonMode, colors, drawAll);
...
void RenderingEngine::renderNormals(Model* model, GLenum polyonMode, bool drawAll)
{
    ...
    renderNormals(objects, polyonMode, drawAll);

    delete obj;
}


void RenderingEngine::renderSilhouette(vector<Object3D*> models, GLenum polyonMode, bool invertDepth, const std::vector<cv::Point3f>& colors, bool drawAll)
{
...
void RenderingEngine::renderShaded(vector<Object3D*> models, GLenum polyonMode, const std::vector<cv::Point3f>& colors, bool drawAll)
{
    glViewport(0, 0, width, height);
...
void RenderingEngine::renderNormals(vector<Object3D*> models, GLenum polyonMode, bool drawAll)
{
    glViewport(0, 0, width, height);
